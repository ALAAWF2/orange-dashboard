...
- النقر على أي فاتورة مورد يفتح نافذة تفاعلية (`#financeInvoiceLinesModal`) لعرض أسطر الفاتورة والأصناف بالتفصيل.
- النقر على أي مورد في جدول التحليل يفتح نافذة تفاعلية (`#financeVendorPaymentsModal`) لعرض سجل حركات الدفع والتسويات البنكية.
...
الإصدار الحالي لأصول المنصة في الصفحة: `20260813-11`.

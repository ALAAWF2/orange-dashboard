...
- تبويب `التقرير المالي الشهري` يقرأ `/api/finance/monthly-income-statement` ولا يخزن أرقامًا مالية في ملفات الواجهة.
...
- التقرير المالي الشهري يعرض قائمة الدخل بدون VAT، مقارنة السنة السابقة، النسب، وكل قيم بعد `Branches` بما فيها المكاتب والمستودعات والمنصات؛ ويُظهر نقص التغطية أو الحسابات غير المصنفة بدل تحويلها إلى صفر مكتمل.
...
الإصدار الحالي لأصول المنصة في الصفحة: `20260910-1`.
